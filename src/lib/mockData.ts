...
export const mockDialogues: Dialogue[] = [
  {
    ...
    lines: [
      ...
      { who: "B", en: "Here you go, enjoy your day!", kr: "여기있습니다, 좋은 하루 되세요!" },
    ],
  },
  {
    title: "길 묻기",
    lines: [
      ...
      { who: "B", en: "No problem, have a safe trip!", kr: "괜찮습니다, 안전한 여행 되세요!" },
    ],
  },
  {
    title: "오랜만에 만난 친구",
    lines: [
      ...
      { who: "B", en: "Sounds perfect, I'll check my schedule.", kr: "좋아, 내 일정 확인해볼게." },
    ],
  },
  {
    kind: "verse",
